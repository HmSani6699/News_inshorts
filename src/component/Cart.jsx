...
const Cart = () => {
  return (
    <div className="cart-container lg:h-[350px] lg:flex gap-[20px] p-[10px] rounded-md mb-[30px]">
      <div className="lg:w-[650px]">
        <img className="w-full h-full rounded-[6px]" src={cart_img} alt="" />
      </div>
      <div className="w-full">
        <h2 className="text-[#44444d] text-[28px] mt-[20px] font-[300]">
          Inshorts featured in Google's Best Apps of 2015
        </h2>
        <p className="text-[#808290] text-[12px] lg:text-[16px]">
          <span className="text-[#2a2a33] text-[20px] font-semibold">
            short
          </span>
          Kabir Khan / 10:52 pm on Saturday, 5 December, 2015
        </p>
        <p className="text-[#828289] text-[20px] mt-[20px]">
        ...
        <p className="mt-[40px]">read more at Goole Play</p>
      </div>
    </div>
  );
};
